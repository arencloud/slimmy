...
#[allow(unused)]
// Relax the compile-time time_t check for toolchains where libc::time_t width
// differs from the generated bindings. This unblocks xtensa builds when the
// bundled libc uses a different time_t than ESP-IDF headers.
const ESP_IDF_TIME64_CHECK_LIBC: ::libc::time_t = 0 as ::libc::time_t;
